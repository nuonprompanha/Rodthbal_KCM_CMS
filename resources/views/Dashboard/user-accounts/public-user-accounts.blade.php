            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title m-0 p-0"><i class="fa-solid fa-user"></i> Public User Accounts</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="8%">Contact</th>
                                        <th class="text-center" width="10%">Login Country</th>
                                        <th class="text-center" width="8%">Status</th>
                                        <th class="text-center" width="8%">User Type</th>
                                ...
                                <tbody>
                                    @forelse($users as $index => $user)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                {{ $user->last_login_location ? \Illuminate\Support\Str::limit($user->last_login_location, 50) : ($user->last_login_at ? 'Local' : '—') }}
                                            </td>
                                            <td class="align-middle text-center">
                                                @if ($user->is_approved)
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="11" class="text-center text-muted">No public users.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="modifyUserType" name="user_type" required>
                                <option value="public" selected>Public (No dashboard access)</option>
                                <option value="authenticated">Authenticated (Dashboard access)</option>
                            </select>
                            <small class="text-muted">Set to Authenticated and assign department to grant dashboard
                                access.</small>
                        </div>
                        <div class="mb-3">
